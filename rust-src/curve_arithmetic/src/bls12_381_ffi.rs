...
macro_derive_to_bytes!(bls_to_bytes_g1, G1, <G1 as Curve>::curve_to_bytes);
macro_derive_to_bytes!(
    bls_to_bytes_scalar,
    <G1 as Curve>::Scalar,
    <G1 as Curve>::scalar_to_bytes
);

macro_derive_from_bytes!(bls_from_bytes_g1, G1, <G1 as Curve>::bytes_to_curve);
