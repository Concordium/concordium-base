    ...
    fn test_expand_message_xmd() {
        ...
        let dst = domain_string.as_bytes();
        {
            ...
            assert_eq!(
                a.to_vec(),
                vec![
                    0x8b, 0xcf, 0xfd, 0x1a, 0x3c, 0xae, 0x24, 0xcf, 0x9c, 0xd7, 0xab, 0x85, 0x62,
                    0x8f, 0xd1, 0x11, 0xbb, 0x17, 0xe3, 0x73, 0x9d, 0x3b, 0x53, 0xf8, 0x95, 0x80,
                    0xd2, 0x17, 0xaa, 0x79, 0x52, 0x6f
                ]
            );
            assert_eq!(
                b.to_vec(),
                vec![
                    0x17, 0x08, 0x35, 0x4a, 0x76, 0xa4, 0x02, 0xd3, 0x56, 0x9d, 0x6a, 0x9d, 0x19,
                    0xef, 0x3d, 0xe4, 0xd0, 0xb9, 0x91, 0xe4, 0xf5, 0x4b, 0x9f, 0x20, 0xdc, 0xde,
                    0x9b, 0x95, 0xa6, 0x68, 0x24, 0xcb
                ]
            );
            assert_eq!(
                c.to_vec(),
                vec![
                    0xdf, 0x6c, 0x1a, 0x96, 0x3a, 0x19, 0x13, 0xd4, 0x3f, 0xd7, 0xac, 0x44, 0x3a,
                    0x02, 0xfc, 0x5d, 0x9d, 0x8d, 0x77, 0xe2, 0x07, 0x1b, 0x86, 0xab, 0x11, 0x4a,
                    0x9f, 0x34, 0x15, 0x09, 0x54, 0xa7
                ]
            );
            assert_eq!(
                d.to_vec(),
                vec![
                    0x53, 0x1d, 0xa5, 0x68, 0xa1, 0xea, 0x8c, 0x76, 0x08, 0x61, 0xc0, 0xcd, 0xe2,
                    0x00, 0x5a, 0xfc, 0x2c, 0x11, 0x40, 0x42, 0xee, 0x7b, 0x58, 0x48, 0xf5, 0x30,
                    0x3f, 0x06, 0x11, 0xcf, 0x29, 0x7f
                ]
            );
        }

        {
            ...
            assert_eq!(
                a.to_vec(),
                vec![
                    0xfe, 0x99, 0x4e, 0xc5, 0x1b, 0xda, 0xa8, 0x21, 0x59, 0x80, 0x47, 0xb3, 0x12,
                    0x1c, 0x14, 0x9b, 0x36, 0x4b, 0x17, 0x86, 0x06, 0xd5, 0xe7, 0x2b, 0xfb, 0xb7,
                    0x13, 0x93, 0x3a, 0xcc, 0x29, 0xc1
                ]
            );
            assert_eq!(
                b.to_vec(),
                vec![
                    0x86, 0xf3, 0x16, 0xba, 0xec, 0xf7, 0xea, 0x22, 0x21, 0x2f, 0x24, 0x96, 0xef,
                    0x3f, 0x78, 0x5a, 0x27, 0xe8, 0x4a, 0x40, 0xd8, 0xb2, 0x99, 0xce, 0xc5, 0x60,
                    0x32, 0x76, 0x3e, 0xce, 0xef, 0xf4
                ]
            );
            assert_eq!(
                c.to_vec(),
                vec![
                    0xc6, 0x1b, 0xd1, 0xfe, 0x65, 0xed, 0x81, 0xde, 0xca, 0xff, 0xf4, 0xa3, 0x1d,
                    0x01, 0x98, 0x61, 0x9c, 0x0a, 0xa0, 0xc6, 0xc5, 0x1f, 0xca, 0x15, 0x52, 0x07,
                    0x89, 0x92, 0x5e, 0x81, 0x3d, 0xcf
                ]
            );
            assert_eq!(
                d.to_vec(),
                vec![
                    0xd3, 0x18, 0xb5, 0x42, 0xf8, 0x79, 0x94, 0x41, 0x27, 0x1f, 0x4d, 0xb9, 0xee,
                    0x3b, 0x80, 0x92, 0xa7, 0xa2, 0xe8, 0xd5, 0xb7, 0x5b, 0x73, 0xe2, 0x8f, 0xb1,
                    0xab, 0x6b, 0x45, 0x73, 0xc1, 0x92
                ]
            );
        }
    }
