...
fn main() {
    ...
    if let Ok(mut file) = fs::File::open("/Users/bassel/Downloads/linuxmint-19-cinnamon-64bit-v2.iso"){ 
       process::<Sha256, _>(&mut file, "/Users/bassel/Downloads/linuxmint-19-cinnamon-64bit-v2.iso");
     }
    else {}
