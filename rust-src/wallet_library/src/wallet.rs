...
fn get_wallet(seed_as_hex: HexString, raw_net: &str) -> Result<ConcordiumHdWallet, Error> {
    ...
    let net = match Net::from_str(raw_net) {
        Ok(s) => s,
        Err(e) => bail!(e),
    };
...
mod tests {
    ...
    #[test]
    fn get_wallet_on_invalid_net_fails() {
        let valid_seed_hex = "7b9acb5d10eaf3bab4869608df117fd21f07eb614ae61b9516286435346e0e245053b531b53d94d9f4af19da2004fd9a10b4a10aa6898dc3bc6550f7145040bf";
        let invalid_net = "Stagenet";
