...
struct GivenContextInfo {
    ...
    // Discussion: Use a `fixed-length` string instead and pad any unused characters as this type
    // is added to the `RandomOracle`.
    ...
    fn serial<B: crate::common::Buffer>(&self, out: &mut B) {
        match self {
            ...
            Challenge::V1(context_info) => {
                ...
                context_info.append_to_transcript(&mut transcript);
                let challenge = transcript.get_challenge();
                challenge.serial(out)
            }
        }
    }
}
...
pub struct Presentation<Challenge: IsChallenge, C: Curve, AttributeType: Attribute<C::Scalar>> {
...
impl<Challenge: IsChallenge, C: Curve, AttributeType: Attribute<C::Scalar>>
    Presentation<Challenge, C, AttributeType>
{
...
impl<Challenge: IsChallenge, C: Curve, AttributeType: Attribute<C::Scalar>> crate::common::Serial
    for Presentation<Challenge, C, AttributeType>
{
    fn serial<B: crate::common::Buffer>(&self, out: &mut B) {
...
impl<Challenge: IsChallenge, C: Curve, AttributeType: Attribute<C::Scalar> + DeserializeOwned>
    TryFrom<serde_json::Value> for Presentation<Challenge, C, AttributeType>
{
    type Error = anyhow::Error;
...
impl<Challenge: IsChallenge, C: Curve, AttributeType: Attribute<C::Scalar> + serde::Serialize>
    serde::Serialize for Presentation<Challenge, C, AttributeType>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    ...
    Request<Challenge, C, AttributeType>
{
    ...
    ) -> Result<Presentation<Challenge, C, AttributeType>, ProofError>
    where
        AttributeType: 'a,
    {
