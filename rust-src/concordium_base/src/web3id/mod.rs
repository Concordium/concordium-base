...
pub struct RequestedContextInfo {
    ...
    fn serial<B: crate::common::Buffer>(&self, out: &mut B) {
        match self {
            ...
            Challenge::V1(context_info) => {
                // Serialize the version/tag before the `ContextChallenge``.
                1u8.serial(out);
