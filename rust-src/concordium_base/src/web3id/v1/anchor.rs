        ...
        let presentation_json = r#"
{
  ...
  "proof": {
        ...
        let verification_request_data_fixture = r#"
    {
        ...
        let _verification_request_data: VerificationRequestData =
            serde_json::from_str(&verification_request_data_fixture).unwrap();

        Ok(())
    }

    #[test]
    fn test_reading_verification_audit_record_fixture_from_json() -> anyhow::Result<()> {
        let verification_audit_record_fixture = r#"
{
    "request": {
    ...
    "type": "ConcordiumVerificationAuditRecord"
        ...
        let _verification_audit_record: VerificationAuditRecord =
            serde_json::from_str(&verification_audit_record_fixture).unwrap();
    ...
    fn test_verification_audit_anchor_cbor_roundtrip() {
        ...
        assert_eq!(hex::encode(&cbor), "a464686173685820c6d691dcd618b6680634e74590dfdd3972c2a9988da7e6dd024f357405190c9e667075626c6963a1636b65790466722374797065664343445641416776657273696f6e01");
    ...
    fn test_compute_the_correct_verification_audit_anchor() -> anyhow::Result<()> {
        ...
        let expected_verification_audit_anchor_hash = Hash::new(
            <[u8; 32]>::from_hex(
                "c6d691dcd618b6680634e74590dfdd3972c2a9988da7e6dd024f357405190c9e",
            )
            .expect("Invalid hex"),
        );
