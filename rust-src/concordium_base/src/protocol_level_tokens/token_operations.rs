use crate::{
    ...
    protocol_level_tokens::{CborAccountAddress, CoinInfo, RawCbor, TokenAmount, TokenId},
    transactions::Memo,
};
...
pub struct TokenTransfer {
    ...
    pub recipient: CborAccountAddress,
    /// An optional memo.
...
pub mod test {
    ...
    use crate::{
        common::cbor,
        protocol_level_tokens::{token_holder::test_fixtures::ADDRESS, CborAccountAddress},
    };
