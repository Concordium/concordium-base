...
/// are to be used.
pub fn generate_pio_old<P: Pairing, C: Curve<Scalar = P::ScalarField>>(
...
>(
    context: IpContext<'a, P, C>,
    id_object: &IdentityObjectOld<P, C, AttributeType>,
...
where
    AttributeType: Clone, {
    let (unsigned_credential_info, commitments_randomness) = create_unsigned_credential_old(
        context,
        id_object,
        id_object_use_data,
        cred_counter,
...
pub fn create_unsigned_credential_old<
    'a,
    P: Pairing,
    C: Curve<Scalar = P::ScalarField>,
    AttributeType: Attribute<C::Scalar>,
