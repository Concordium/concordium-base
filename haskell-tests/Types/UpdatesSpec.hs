...
checkUpdateInstructionSerialization :: SProtocolVersion cpv -> UpdateInstruction -> Property
...
testSerializeUpdatePayload :: SProtocolVersion pv -> Property
...
-- we get back the value we started with.
testJSONUpdatePayload ::  SChainParametersVersion cpv -> Property
...
testUpdateInstruction :: SProtocolVersion pv -> SignKeyGen -> Bool -> Property
testUpdateInstruction spv keyGen isValid =
  forAll (genKeyCollection scpv 3) $ \(kc, rootK, level1K, level2K) ->
