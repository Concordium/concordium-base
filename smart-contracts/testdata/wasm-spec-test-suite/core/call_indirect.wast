...
(module
  ...
  (type $i32-i32 (func (param i32 i32) (result i32)))
  (type $i32-i64 (func (param i32 i64) (result i64)))
  (type $i64-i32 (func (param i64 i32) (result i32)))
  ...
  (func $const-i64 (type $out-i64) (i64.const 0))

  (func $id-i32 (type $over-i32) (local.get 0))
  (func $id-i64 (type $over-i64) (local.get 0))

  (func $i32-i64 (type $i32-i64) (local.get 1))
  (func $i64-i64 (type $i64-i64) (local.get 1))
  (func $i32-i32 (type $i32-i32) (local.get 1))
  (func $i64-i32 (type $i64-i32) (local.get 1))
  ...
  (table funcref
    (elem
      $const-i32 $const-i64 $const-i32 $const-i64  ;; 0..3
      $id-i32 $id-i64 $id-i32 $id-i64              ;; 4..7
      $i32-i32 $i32-i64 $i64-i32 $i64-i64          ;; 9..11
      $fac-i64 $fib-i64 $even $odd                 ;; 12..15
      $runaway $mutual-runaway1 $mutual-runaway2   ;; 16..18
      $over-i32-duplicate $over-i64-duplicate      ;; 19..20
      $over-i32-duplicate $over-i64-duplicate      ;; 21..22
      $fac-i32 $fac-i32 $fac-i64                   ;; 23..25
      $fib-i32 $fib-i32 $fib-i64                   ;; 26..28
    )
  )
  ...
  (func
    ...
    (call_indirect (param i64) (param) (param i64 i32 i64)
      (i64.const 0) (i64.const 0) (i32.const 0) (i64.const 0) (i32.const 0)
    )
    ...
    (drop (i32.eqz
      (call_indirect
        (param) (param i64) (param) (param i64 i32 i64) (param) (param)
  ...
  (func (export "type-second-i32") (result i32)
    (call_indirect (type $i32-i32) (i32.const 32) (i32.const 32) (i32.const 8))
  )
  ...
  (func (export "as-unary-operand") (result i32)
    (block (result i32)
      (i32.eqz
        (call_indirect (type $over-i32) (i32.const 0) (i32.const 6))
      )
    )
  )
...
(assert_return (invoke "type-i32") (i32.const 0))
(assert_return (invoke "type-i64") (i64.const 0))
(assert_return (invoke "type-i32") (i32.const 0))
(assert_return (invoke "type-i64") (i64.const 0))
(assert_return (invoke "type-i64-i32") (i64.const 0) (i32.const 32))
...
(assert_return (invoke "type-all-i64-i32") (i64.const 0) (i32.const 32))
(assert_return (invoke "type-all-i32-i64") (i32.const 1) (i64.const 2))
...
(assert_return (invoke "dispatch-structural-i64" (i32.const 22)) (i64.const 9))
...
(assert_return (invoke "dispatch-structural-i32" (i32.const 6)) (i32.const 9))
(assert_return (invoke "dispatch-structural-i32" (i32.const 24)) (i32.const 362880))
(assert_return (invoke "dispatch-structural-i32" (i32.const 27)) (i32.const 55))
(assert_return (invoke "dispatch-structural-i32" (i32.const 21)) (i32.const 9))
(assert_trap (invoke "dispatch-structural-i32" (i32.const 8)) "indirect call type mismatch")

(assert_return (invoke "dispatch-structural-i64" (i32.const 7)) (i64.const 9))
(assert_return (invoke "dispatch-structural-i64" (i32.const 25)) (i64.const 362880))
(assert_return (invoke "dispatch-structural-i64" (i32.const 28)) (i64.const 55))
(assert_return (invoke "dispatch-structural-i64" (i32.const 22)) (i64.const 9))
(assert_trap (invoke "dispatch-structural-i64" (i32.const 10)) "indirect call type mismatch")
(assert_trap (invoke "dispatch-structural-i64" (i32.const 18)) "indirect call type mismatch")
...
(assert_return (invoke "fac-i64" (i64.const 1)) (i64.const 1))
(assert_return (invoke "fac-i64" (i64.const 5)) (i64.const 120))
(assert_return (invoke "fac-i64" (i64.const 10)) (i64.const 3628800))
...
(assert_return (invoke "as-select-first") (i32.const 0))
(assert_return (invoke "as-select-mid") (i32.const 2))
(assert_return (invoke "as-select-last") (i32.const 3))

(assert_return (invoke "as-if-condition") (i32.const 2))

(assert_return (invoke "as-br_if-first") (i64.const 0))
(assert_return (invoke "as-br_if-last") (i32.const 2))

(assert_return (invoke "as-br_table-first") (i32.const 0))
...
(assert_return (invoke "as-local.set-value") (i64.const 1))
(assert_return (invoke "as-local.tee-value") (i64.const 1))
(assert_return (invoke "as-global.set-value") (i64.const 1))
(assert_return (invoke "as-load-operand") (i32.const 0))

(assert_return (invoke "as-unary-operand") (i32.const 1))
...
(assert_invalid
  (module
    ...
    (table 0 funcref)
    (func $arity-2-vs-0
      (call_indirect (type 0) (i64.const 2) (i32.const 1) (i32.const 0))
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-first-num-vs-num
      (call_indirect (type 0) (i64.const 1) (i32.const 1) (i32.const 0))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-second-num-vs-num
      (call_indirect (type 0) (i32.const 1) (i64.const 1) (i32.const 0))
    )
  )
  "type mismatch"
)
