(module
  ...
  ;; Simple init and receive functions used for integration testing of cryptographic primitives.
  ...
  (func (export "hostfn.verify_ed25519_signature") (param i64) (result i32)
      ...
      (i32.store (i32.const 0) (call $verify_ed25519_signature (i32.const 0) (i32.const 32) (i32.const 100) (local.get $len)))
      (call $write_output (i32.const 0) (i32.const 4) (i32.const 0))
      (return (i32.const 0))
  )
  ...
  (func (export "hostfn.verify_ecdsa_secp256k1_signature") (param i64) (result i32)
      ...
      (i32.store (i32.const 0) (call $verify_ecdsa_secp256k1_signature (i32.const 0) (i32.const 33) (i32.const 97)))
      (call $write_output (i32.const 0) (i32.const 4) (i32.const 0))
      (return (i32.const 0))
  )
  ...
  (func (export "hostfn.hash_sha2_256") (param i64) (result i32)
      ...
      (call $hash_sha2_256 (i32.const 4) (local.get $len) (i32.const 0))
      (call $write_output (i32.const 0) (i32.const 32) (i32.const 0))
      (return (i32.const 0))
  )
  ...
  (func (export "hostfn.hash_sha3_256") (param i64) (result i32)
      ...
      (call $get_parameter_section (i32.const 0) (i32.const 0) (i32.const 4) (i32.const 0))
      (local.set $len (i32.load (i32.const 0)))
      (call $hash_sha3_256 (i32.const 4) (local.get $len) (i32.const 0))
      (call $write_output (i32.const 0) (i32.const 32) (i32.const 0))
      (return (i32.const 0))
  )
  ...
  (func (export "hostfn.hash_keccak_256") (param i64) (result i32)
      ...
      (call $get_parameter_section (i32.const 0) (i32.const 0) (i32.const 4) (i32.const 0))
      (local.set $len (i32.load (i32.const 0)))
      (call $hash_keccak_256 (i32.const 4) (local.get $len) (i32.const 0))
      (call $write_output (i32.const 0) (i32.const 32) (i32.const 0))
      (return (i32.const 0))
  )
  (memory 2)
...
;; Local Variables:
;; compile-command: "wat2wasm crypto-primitives-tests.wat"
;; End:
