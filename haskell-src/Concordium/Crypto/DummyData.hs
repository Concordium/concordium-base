...
-- |Generate an account key pair from a given seed. This is not cryptographically secure, so
-- should not be used outside of testing.
{-# WARNING deterministicKP "Do not use in production" #-}
deterministicKP :: Int -> SigScheme.KeyPair
deterministicKP = uncurry SigScheme.KeyPairEd25519 . fst . randomEd25519KeyPair . mkStdGen

-- |The 'SigScheme.VerifyKey' corresponding to the key pair generated by 'deterministicKP'.
{-# WARNING deterministicVK "Do not use in production" #-}
deterministicVK :: Int -> SigScheme.VerifyKey
deterministicVK = correspondingVerifyKey . deterministicKP
