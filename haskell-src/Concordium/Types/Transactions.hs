...
data SignedTransaction = SignedTransaction
    { -- | A version to destinguish between future formats of signed/partially-signed transactions.
      ...
      stPayload :: !Payload,
      -- | Signatures generated by the signer account. This map might be contain enough signatures to send the transaction on-chain or
