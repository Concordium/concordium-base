...
void
ed25519_scalar_encode (unsigned char out[32], const bignum256modm in) {
    contract256_modm(out, in);
}

void
ed25519_scalar_decode_long (bignum256modm out, const unsigned char *in, size_t len) {
    expand256_modm(out, in, len);
}

int
ed25519_scalar_eq (const bignum256modm a, const bignum256modm b) {
...
void
ed25519_scalar_add (bignum256modm r, const bignum256modm x, const bignum256modm y) {
    add256_modm(r, x, y);
}

void
ed25519_scalar_mul (bignum256modm r, const bignum256modm x, const bignum256modm y) {
    mul256_modm(r, x, y);
}
...
void
ed25519_point_encode (unsigned char r[32], const ge25519 *p) {
    ge25519_pack(r, p);
}

int
ed25519_point_decode_vartime (ge25519 *r, const unsigned char p[32]) {
...
int
ed25519_point_eq (const ge25519 *p, const ge25519 *q) {
    bignum25519 a, b;
...
static int
ed25519_point_is_identity (const ge25519 *p) {
...
void
ed25519_point_negate (ge25519 *r, const ge25519 *p) {
...
void
ed25519_point_add (ge25519 *r, const ge25519 *p, const ge25519 *q) {
    ge25519_add(r, p, q);
}

void
ed25519_point_double (ge25519 *r, const ge25519 *p) {
    ge25519_double(r, p);
}

void
ed25519_point_mul_by_cofactor (ge25519 *r, const ge25519 *p) {
...
void
ed25519_point_base_scalarmul (ge25519 *r, const bignum256modm s) {
...
void
ed25519_point_scalarmul (ge25519 *r, const ge25519 *p, const bignum256modm s) {
...
void
ed25519_base_double_scalarmul_vartime (ge25519 *r, const bignum256modm s1, const ge25519 *p2, const bignum256modm s2) {
    // computes [s1]basepoint + [s2]p2
    ge25519_double_scalarmult_vartime(r, p2, s2, s1);
}

int
ed25519_point_has_prime_order (const ge25519 *p) {
    static const bignum256modm sc_zero = {0};
    ge25519 q;

    // computes Q = m.P, vartime allowed because m is not secret
    ed25519_base_double_scalarmul_vartime (&q, sc_zero, p, modm_m);

    return ed25519_point_is_identity (&q);
}
